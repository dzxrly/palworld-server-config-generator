...
function Fe(e, t) {
  ...
  for (; n.length; ) {
    ...
    Object.keys(r).forEach((l) => {
      De(r[l]) || De(a[l]) ? (a[l] = r[l]) : n.push({ src: r[l], des: a[l] });
    });
  }
}
/*!
...
function jn(e) {
  ...
  const c = (k) => t[k] === Xn && t[k + 1] === H,
    ...
    u = () => D(n + l);
  function N() {
    return (l = 0), p(n) && (r++, (a = 0)), c(n) && n++, n++, a++, t[n];
  }
  function I() {
...
function Qn(e, t = {}) {
  ...
  function T(s, o, m, ...O) {
    ...
    if (((o.column += m), (o.offset += m), p)) {
      const v = n ? ze(M.startLoc, o) : null,
        Z = Te(s, v, { domain: Jn, args: O });
      p(Z);
    }
  }
  function L(s, o, m) {
    (s.endLoc = l()), (s.currentType = o);
    const O = { type: o };
    return (
      n && (O.loc = ze(s.startLoc, s.endLoc)), m != null && (O.value = m), O
    );
  }
  const S = (s) => L(s, 14);
  function y(s, o) {
    return s.currentChar() === o
      ? (s.next(), o)
      : (T(R.EXPECTED_TOKEN, l(), 0, o), '');
  }
  function D(s) {
    let o = '';
    for (; s.currentPeek() === re || s.currentPeek() === H; )
  ...
  function E(s, o) {
    ...
    if (m !== 2) return !1;
    D(s);
    const O = s.currentPeek() === '-' ? s.peek() : s.currentPeek(),
      M = N(O);
  ...
  function ce(s) {
    const o = D(s),
      m = s.currentPeek() === '%' && s.peek() === '{';
    return s.resetPeek(), { isModulo: m, hasSpace: o.length > 0 };
  }
  function J(s, o = !0) {
    const m = (M = !1, v = '', Z = !1) => {
        const ne = s.currentPeek();
        return ne === '{'
          ? v === '%'
            ? !1
            : M
      ...
      O = m();
    return o && s.resetPeek(), O;
  }
  function fe(s, o) {
    const m = s.currentChar();
    return m === oe ? oe : o(m) ? (s.next(), m) : null;
  }
  function Ae(s) {
    return fe(s, (m) => {
  ...
  function Xe(s) {
    ...
    return o !== '%' && T(R.EXPECTED_TOKEN, l(), 0, o), s.next(), '%';
  }
  function Se(s) {
    let o = '';
    for (;;) {
  ...
  function te(s) {
    ...
    let o = '',
      m = '';
    for (; (o = Ae(s)); ) m += o;
    return s.currentChar() === oe && T(R.UNTERMINATED_CLOSING_BRACE, l(), 0), m;
  }
  function ye(s) {
    C(s);
    let o = '';
    return (
      s.currentChar() === '-' ? (s.next(), (o += `-${Pe(s)}`)) : (o += Pe(s)),
      s.currentChar() === oe && T(R.UNTERMINATED_CLOSING_BRACE, l(), 0),
      o
    );
  }
  function He(s) {
    ...
    let o = '',
      m = '';
    const O = (v) => v !== Tt && v !== H;
    for (; (o = fe(s, O)); ) o === '\\' ? (m += Ke(s)) : (m += o);
    const M = s.currentChar();
    return M === H || M === oe
      ? (T(R.UNTERMINATED_SINGLE_QUOTE_IN_PLACEHOLDER, l(), 0),
        M === H && (s.next(), y(s, "'")),
        m)
      : (y(s, "'"), m);
  }
  function Ke(s) {
    ...
    switch (o) {
      ...
      case 'U':
        return Re(s, o, 6);
      default:
        return T(R.UNKNOWN_ESCAPE_SEQUENCE, l(), 0, o), '';
    }
  }
  function Re(s, o, m) {
    y(s, o);
  ...
  function Ie(s, o) {
    ...
    switch (s.currentChar()) {
      case '{':
        return (
          o.braceNest >= 1 && T(R.NOT_ALLOW_NEST_PLACEHOLDER, l(), 0),
          s.next(),
          (m = L(o, 2, '{')),
          C(s),
          o.braceNest++,
      ...
      case '@':
        return (
          o.braceNest > 0 && T(R.UNTERMINATED_CLOSING_BRACE, l(), 0),
          (m = de(s, o) || S(o)),
          (o.braceNest = 0),
          m
        );
      default:
        ...
        if (
          ...
          return (
            T(R.UNTERMINATED_CLOSING_BRACE, l(), 0), (o.braceNest = 0), Oe(s, o)
          );
        if ((M = I(s, o))) return (m = L(o, 5, te(s))), C(s), m;
        if ((v = E(s, o))) return (m = L(o, 6, ye(s))), C(s), m;
        if ((Z = b(s, o))) return (m = L(o, 7, He(s))), C(s), m;
        if (!M && !v && !Z)
          return (
            (m = L(o, 13, je(s))),
            T(R.INVALID_TOKEN_IN_PLACEHOLDER, l(), 0, m.value),
            C(s),
            m
          );
        break;
  ...
  function de(s, o) {
    ...
    switch (
      ((m === 8 || m === 9 || m === 12 || m === 10) &&
        (M === H || M === re) &&
        T(R.INVALID_LINKED_FORMAT, l(), 0),
      M)
    ) {
      case '@':
        return s.next(), (O = L(o, 8, '@')), (o.inLinked = !0), O;
      case '.':
        return C(s), s.next(), L(o, 9, '.');
      case ':':
        return C(s), s.next(), L(o, 10, ':');
      default:
        return B(s)
          ? ((O = L(o, 1, pe(s))), (o.braceNest = 0), (o.inLinked = !1), O)
          : h(s, o) || A(s, o)
          ? (C(s), de(s, o))
          : k(s, o)
          ? (C(s), L(o, 12, Et(s)))
          : $(s, o)
          ? (C(s), M === '{' ? Ie(s, o) || O : L(o, 11, Be(s)))
          : (m === 8 && T(R.INVALID_LINKED_FORMAT, l(), 0),
            (o.braceNest = 0),
            (o.inLinked = !1),
            Oe(s, o));
    }
  ...
  function Oe(s, o) {
    let m = { type: 14 };
    if (o.braceNest > 0) return Ie(s, o) || S(o);
    if (o.inLinked) return de(s, o) || S(o);
    switch (s.currentChar()) {
      case '{':
        return Ie(s, o) || S(o);
      case '}':
        return T(R.UNBALANCED_CLOSING_BRACE, l(), 0), s.next(), L(o, 3, '}');
      case '@':
        return de(s, o) || S(o);
      default:
        if (B(s))
          return (m = L(o, 1, pe(s))), (o.braceNest = 0), (o.inLinked = !1), m;
        const { isModulo: M, hasSpace: v } = ce(s);
        if (M) return v ? L(o, 0, Se(s)) : L(o, 4, Xe(s));
        if (J(s)) return L(o, 0, Se(s));
        break;
    }
    return m;
  }
  function Je() {
    const { currentType: s, offset: o, startLoc: m, endLoc: O } = i;
    return (
      (i.lastType = s),
      (i.lastOffset = o),
      (i.lastStartLoc = m),
  ...
  return { nextToken: Je, currentOffset: a, currentPosition: l, context: d };
}
const qn = 'parser',
...
function er(e = {}) {
  ...
  function c(u, N) {
    ...
    return (E.value = N), l(E, u.currentOffset(), u.currentPosition()), E;
  }
  function f(u, N) {
    const I = u.context(),
    ...
    return (
      ...
      u.nextToken(),
      l(h, u.currentOffset(), u.currentPosition()),
      h
    );
  }
  function i(u, N) {
  ...
  function L(u) {
    ...
    switch (
      ...
      default:
        ...
        return (
          (h.value = ''),
          l(h, b.offset, b.startLoc),
          (I.key = h),
          l(I, b.offset, b.startLoc),
          { nextConsumeToken: E, node: I }
        );
    }
    return l(I, u.currentOffset(), u.currentPosition()), { node: I };
  }
  function S(u) {
    const N = u.context(),
  ...
  function y(u, N, I, E) {
    ...
    return (
      ...
      l(k, u.currentOffset(), u.currentPosition()),
      k
    );
  }
  function D(u) {
  ...
  function C(u) {
    ...
    return (
      ...
      l(E, N.currentOffset(), N.currentPosition()),
      E
    );
  }
  return { parse: C };
...
function Ne(e) {
  switch (((e.t = e.type), e.type)) {
    ...
    case 2:
      const a = e,
        l = a.items;
      for (let p = 0; p < l.length; p++) Ne(l[p]);
      (a.i = l),
        delete a.items,
...
function or(e, t) {
  ...
  for (let l = 0; l < a && (ge(e, t.items[l]), l !== a - 1); l++) e.push(', ');
  e.deindent(r()), e.push('])');
}
function ir(e, t) {
  const { helper: n, needIndent: r } = e;
  if (t.cases.length > 1) {
    ...
    for (let l = 0; l < a && (ge(e, t.cases[l]), l !== a - 1); l++)
      e.push(', ');
    e.deindent(r()), e.push('])');
  }
}
...
function tn(e, t, n) {
  ...
  if (!l) {
    ...
    (c = P(f) ? [f] : f), Y(c) && Ct(l, c, !1), a.__localeChainCache.set(r, l);
  }
  return l;
}
function Ct(e, t, n) {
...
function $r(e, t) {
  ...
  if ((n.t || n.type) === 1) {
    const r = n,
      a = r.c || r.cases;
    return e.plural(a.reduce((l, c) => [...l, Rt(e, c)], []));
  } else return Rt(e, n);
}
function Rt(e, t) {
  ...
  {
    const r = (t.i || t.items).reduce((a, l) => [...a, et(e, l)], []);
...
function Xr(e, t) {
  if (
    ...
    const r = (t.onCacheKey || Yr)(e),
      a = Me[r];
    if (a) return a;
    const { ast: l, detectError: c } = Gr(e, { ...t, location: !1, jit: !0 }),
      f = qe(l);
    return c ? f : (Me[r] = f);
  } else {
    const n = e.cacheKey;
    ...
    P(n)
      ...
      : F(n) &&
        Object.keys(n).forEach((i) => {
          on.includes(i) ? (c[i] = n[i]) : (l[i] = n[i]);
        }),
    P(r) ? (l.locale = r) : F(r) && (c = r),
    F(a) && (c = a),
    [l.key || '', f, l, c]
  );
}
  ...
  for (const t in e)
    if (!!We(e, t))
      if (!t.includes('.')) U(e[t]) && Ce(e[t]);
        ...
        l || ((a[n[r]] = e[t]), delete e[t]), U(a[n[r]]) && Ce(a[n[r]]);
      }
  return e;
}
function mn(e, t) {
...
const ra = ot({
    ...
    setup(e, t) {
      ...
      return () => {
        const l = Object.keys(n).filter((T) => T !== '_'),
          c = {};
...
function Ea(e, t, n = !1) {
  ...
  for (; l != null; ) {
    const c = e;
    if (
      (e.mode === 'composition' && (r = c.__getInstance(l)),
      r != null || a === l)
    )
      break;
    l = l.parent;
...
function Ta(e, t) {
  ...
  return (
    La.forEach((a) => {
      ...
      if (!l) throw q(Q.UNEXPECTED_ERROR);
      const c = Cn(l.value)
        ? {
            get() {
    ...
    Kt.forEach((a) => {
      const l = Object.getOwnPropertyDescriptor(t, a);
      if (!l || !l.value) throw q(Q.UNEXPECTED_ERROR);
